...
RSpec.describe EmailAddressesController, type: :controller do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      let(:alice) {Person.create(first_name: 'Alice', last_name: 'Smith')}
      let(:valid_attributes) {{address: 'rollin@beatty.info', person_id: alice.id}}
      let(:new_attributes) {{address: 'ulises.koepp@graham.name',person_id: alice.id}}
      ...
      it "updates the requested email_address" do
        ...
        expect(email_address.address).to eq('ulises.koepp@graham.name')
      end
  ...
  describe "DELETE #destroy" do
    ...
    let(:james) {Person.create(first_name: 'James', last_name: 'Jones')}
    let(:valid_attributes) {{address: 'edyth.moriette@yost.info', person_id: james.id}}
    ...
    it "redirects to the email_addresses list" do
      email_address = EmailAddress.create! valid_attributes
      delete :destroy, {:id => email_address.to_param}, valid_session
      expect(response).to redirect_to(james)
    end
  end
